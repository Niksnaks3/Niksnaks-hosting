...
class NiksnaksHostingApplication(Adw.Application):
    ...
    def _on_shortcuts(self, action, param):
        ...
        if self._shortcuts_dialog is None:
            from niksnaks_hosting.gtk_ui.dialogs.shortcuts import create_shortcuts_dialog
    ...
    def _on_change_icon(self, action, param):
        ...
        from niksnaks_hosting.gtk_ui.dialogs.icon_picker import IconPickerDialog
    ...
    def _on_delete_server(self, action, param):
        ...
        dialog.add_response("delete", _("Yes"))
