...
class ModrinthMixin:
    ...
    def _build_modrinth_search_view(self) -> Gtk.Widget:
        ...
        entry.set_placeholder_text(_("Search {} mods…").format(get_loader_display_name(self._server_loader())))
        ...
        def update_search_hint() -> None:
            ...
            if ptype == "modpack":
                entry.set_placeholder_text(_("Search {} modpacks…").format(loader_name))
            elif ptype == "datapack":
                entry.set_placeholder_text(_("Search datapacks…"))
            else:
                entry.set_placeholder_text(_("Search {} mods…").format(loader_name))
