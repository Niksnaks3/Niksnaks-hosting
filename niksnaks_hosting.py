...
def _configure_windows_app_identity() -> None:
    ...
    try:
        ...
        ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("com.niksnakshosting.NiksnaksHosting")
    except Exception:
        pass

    from niksnaks_hosting.shared.utils.windows_instance import is_first_instance, signal_show
...
def _format_missing_gtk_message() -> str:
    if sys.platform == "win32":
        return (
            ...
            "then run Niksnaks-Hosting with that environment's Python."
        )
